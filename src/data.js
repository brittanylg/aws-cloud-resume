  ...
  projects: [
    {
      ...
      description: 'The original challege rules called for a simple HTML and CSS resume website to be built, including a visitor counter written in JavaScript.  Since I have a lot of front end experience, I decided to build a resume website using React instead.  The website is deployed to Amazon S3 as a static website.',
